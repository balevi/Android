...
public class GoleiroAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        TextView DataJogo = vw.findViewById(R.id.DataJogo1);
        TextView HoraJogo = vw.findViewById(R.id.HoraJogo1);
        ...
        idade.setText(g.getTxtPrecisa());
        DataJogo.setText(g.getDataJogo());
        HoraJogo.setText(g.getHoraJogo());
